            ...
            <div class="col-lg-9 mt-lg-0 mt-5 right-product-grid">
                ...
                <div class="card-group my-5">
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pg6.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/girls" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="card-group">
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pg9.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/girls" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pg10.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/girls" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pg11.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/girls" class="link-product-add-cart">Quick View</a>
                                    </div>
