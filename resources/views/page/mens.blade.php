            ...
            <div class="col-lg-4 single-right-left">
                <div class="grid images_3_of_2">
                    <div class="flexslider1">
                        <ul class="slides">
                            <li data-thumb="{{ asset('template') }}/images/ms1.jpg">
                                <div class="thumb-image">
                                    <img src="{{ asset('template') }}/images/ms1.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                            </li>
                            <li data-thumb="{{ asset('template') }}/images/ms2.jpg">
                                <div class="thumb-image">
                                    <img src="{{ asset('template') }}/images/ms2.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                            </li>
                            <li data-thumb="{{ asset('template') }}/images/ms3.jpg">
                                <div class="thumb-image">
                                    <img src="{{ asset('template') }}/images/ms3.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                            </li>
                        </ul>
