            ...
            <div class="col-lg-4 single-right-left">
                <div class="grid images_3_of_2">
                    <div class="flexslider1">
                        <ul class="slides">
                            <li data-thumb="{{ asset('template') }}/images/pbb1.jpg">
                                <div class="thumb-image">
                                    <img src="{{ asset('template') }}/images/pbb1.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                            </li>
                            <li data-thumb="{{ asset('template') }}/images/pbb2.jpg">
                                <div class="thumb-image">
                                    <img src="{{ asset('template') }}/images/pbb2.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                            </li>
                            <li data-thumb="{{ asset('template') }}/images/pbb3.jpg">
                                <div class="thumb-image">
                                    <img src="{{ asset('template') }}/images/pbb3.jpg" data-imagezoom="true" alt=" " class="img-fluid"> </div>
                            </li>
                        </ul>
    ...
    <div class="container">
        <div class="new_arrivals">
            ...
            <div class="card-group my-5">
                ...
                <div class="card product-men p-3">
                    <div class="men-thumb-item">
                        <img src="{{ asset('template') }}/images/pb11.jpg" alt="img" class="card-img-top">
                        <div class="men-cart-pro">
                            <div class="inner-men-cart-pro">
                                <a href="/boys" class="link-product-add-cart">Quick View</a>
                            </div>
