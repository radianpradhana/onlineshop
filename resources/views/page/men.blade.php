        ...
        <div class="col-lg-9 mt-lg-0 mt-5 right-product-grid">
            ...
            <div class="card-group">
                ...
                <div class="col-lg-3 col-sm-6 p-0">
                    ...
                    <div class="card product-men p-3">
                        <div class="men-thumb-item">
                            <img src="{{ asset('template') }}/images/pm3.jpg" alt="img" class="card-img-top">
                            <div class="men-cart-pro">
                                <div class="inner-men-cart-pro">
                                    <a href="/mens" class="link-product-add-cart">Quick View</a>
                                </div>
                ...
                <div class="col-lg-3 col-sm-6 p-0">
                    <div class="card product-men p-3">
                        <div class="men-thumb-item">
                            <img src="{{ asset('template') }}/images/pm9.jpg" alt="img" class="card-img-top">
                            <div class="men-cart-pro">
                                <div class="inner-men-cart-pro">
                                    <a href="/mens" class="link-product-add-cart">Quick View</a>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3 out_w3">
                            <div class="men-thumb-item position-relative">
                                <img src="{{ asset('template') }}/images/pm7.jpg" alt="img" class="card-img-top">
                ...
                <div class="card-group">
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pt4.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/mens" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="card-group mt-5">
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pt5.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/mens" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pt6.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/mens" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pt7.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/mens" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 p-0">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pt8.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/mens" class="link-product-add-cart">Quick View</a>
                                    </div>
