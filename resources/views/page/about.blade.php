    ...
    <div class="col-sm-4">
        <div class="hovereffect">
            ...
            <div class="overlay">
                ...
                <a class="info" href="/women">Shop Now</a>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="hovereffect">
            ...
            <div class="overlay">
                <h5>men's fashion</h5>
                <a class="info" href="/men">Shop Now</a>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="hovereffect">
            ...
            <div class="overlay">
                <h5>kid's fashion</h5>
                <a class="info" href="/boy">Shop Now</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div id="owl-demo" class="owl-carousel text-center">
                    ...
                    <div class="item">
                        <div class="product-men p-3 text-center">
                            ...
                            <a href="/women" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="men" aria-labelledby="men-tab">
                <div id="owl-demo1" class="owl-carousel text-center">
                    ...
                    <div class="item">
                        ...
                        <div class="product-men p-3 text-center">
                            <img src="{{ asset('template') }}/images/p2.png" class="img-responsive" alt="">
                            <a href="/men" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                        <!-- //card -->
                    </div>
                </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="girl" aria-labelledby="girl-tab">
                <div id="owl-demo2" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                ...
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/girl" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            </div>
                            <!-- card body -->
                    ...
                    <div class="item">
                        <div class="product-men p-3 text-center">
                            <img src="{{ asset('template') }}/images/p2.png" class="img-responsive" alt="" />
                            <a href="/girl" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="boy" aria-labelledby="boy-tab">
                <div id="owl-demo3" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                ...
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/boy" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            </div>
                            <!-- card body -->
                    ...
                    <div class="item">
                        <div class="product-men p-3 text-center">
                            <img src="{{ asset('template') }}/images/p2.png" class="img-responsive" alt="" />
                            <a href="/boys" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                    </div>
                </div>
            </div>
