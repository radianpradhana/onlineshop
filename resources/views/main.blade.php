...
<div class="row no-gutters pb-5">
    <div class="col-sm-4">
        <div class="hovereffect">
            <img class="img-fluid" src="{{ asset('template') }}/images/a1.jpg" alt="">
            <div class="overlay">
                <h5>women's fashion</h5>
                <a class="info" href="{{ asset('template') }}/women.html">Shop Now</a>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="hovereffect">
            <img class="img-fluid" src="{{ asset('template') }}/images/a2.jpg" alt="">
            <div class="overlay">
                <h5>men's fashion</h5>
                <a class="info" href="{{ asset('template') }}/men.html">Shop Now</a>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="hovereffect">
            <img class="img-fluid" src="{{ asset('template') }}/images/a3.jpg" alt="">
            <div class="overlay">
                <h5>kid's fashion</h5>
                <a class="info" href="{{ asset('template') }}/girls.html">Shop Now</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div id="owl-demo" class="owl-carousel text-center">
                            ...
                            <div class="men-thumb-item">
                                ...
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/womens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            </div>
                            <!-- card body -->
                    ...
                    <div class="item">
                        <div class="product-men p-3 text-center">
                            <img src="{{ asset('template') }}/images/p2.png" class="img-responsive" alt="" />
                            <a href="{{ asset('template') }}/women.html" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="men" aria-labelledby="men-tab">
                <div id="owl-demo1" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pm1.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            </div>
                            <!-- card body -->
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pm2.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pt1.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pt2.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class=" card product-men p-3 ">
                            <div class="men-thumb-item ">
                                <img src="{{ asset('template') }}/images/pt3.jpg " alt="img " class="card-img-top ">
                                <div class="men-cart-pro ">
                                    <div class="inner-men-cart-pro ">
                                        <a href="{{ asset('template') }}/mens.html " class="link-product-add-cart ">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="product-men p-3 text-center">
                            <img src="{{ asset('template') }}/images/p2.png" class="img-responsive" alt="">
                            <a href="{{ asset('template') }}/men.html" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                        <!-- //card -->
                    </div>
                </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="girl" aria-labelledby="girl-tab">
                <div id="owl-demo2" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pg1.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/girl.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            </div>
                            <!-- card body -->
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pg2.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/girl.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pg3.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/girl.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3 out_w3">
                            <div class="men-thumb-item position-relative">
                                <img src="{{ asset('template') }}/images/pg7.jpg" alt="img" class="card-img-top">
                    ...
                    <div class="item">
                        <div class="product-men p-3 text-center">
                            <img src="{{ asset('template') }}/images/p2.png" class="img-responsive" alt="" />
                            <a href="{{ asset('template') }}/girls.html" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="boy" aria-labelledby="boy-tab">
                <div id="owl-demo3" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                ...
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            </div>
                            <!-- card body -->
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pb2.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pb3.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3 out_w3">
                            <div class="men-thumb-item position-relative">
                                <img src="{{ asset('template') }}/images/pb7.jpg" alt="img" class="card-img-top">
                                <span class="px-2 position-absolute">out of stock</span>
                            </div>
                            <!-- card body -->
                            <div class="card-body  py-3 px-2">
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pb4.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pb5.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pb6.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{ asset('template') }}/images/pb8.jpg" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ asset('template') }}/boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        <div class="product-men p-3 text-center">
                            <img src="{{ asset('template') }}/images/p2.png" class="img-responsive" alt="" />
                            <a href="{{ asset('template') }}/boys.html" class="btn btn-lg bg-info text-white">view more</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-lg-5">
    ...
    <div class="gallery row no-gutters pt-lg-5">
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i1.jpg" class="img-fluid" alt="" />
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i2.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i3.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i4.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i5.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 38</li>
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i6.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 38</li>
    ...
    <div class="gallery row no-gutters pb-5">
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i7.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 56</li>
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i8.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 89</li>
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i9.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 42</li>
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i10.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 38</li>
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i11.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 38</li>
        ...
        <div class="col-lg-2 col-sm-4 col-6 gallery-item">
            <img src="{{ asset('template') }}/images/i12.jpg" class="img-fluid" alt="" />
            <div class="gallery-item-info">
                <ul>
                    <li class="gallery-item-likes">
                        <i class="fas fa-heart"></i> 38</li>
